...
const ChatPage = () => {
  ...
  //       {/* room name container */}
  //       <div>
  //         <h1 className="text-xl font-semibold border p-2 border-gray-700 rounded-3xl">
  ...
  //     <main
  //       ref={chatBoxRef}
  //       className="py-20 px-10   w-2/3 dark:bg-slate-500 mx-auto h-screen overflow-auto "
  //     >
  ...
  //       <div className="h-full  pr-10 gap-4 flex items-center justify-between rounded-full w-1/2 mx-auto dark:bg-gray-700">
  //         <input
  //           value={input}
  //           onChange={(e) => {
  ...
  //           className=" w-full  dark:border-gray-900 b dark:bg-gray-800  px-5 py-2 rounded-full h-full focus:outline-none  "
  //         />
  ...
  return (
    <div className="flex w-full min-h-screen">
      {/* Replace [] with actual list if available */}
      <Sidebar
        conversations={[]}
        selectedUser={currentUser}
        setSelectedUser={(user) => setCurrentUser(user.userName)}
      />
      <ChatWindow
        messages={messages}
